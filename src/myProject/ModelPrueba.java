...
public class ModelPrueba {
     ...
     */
    private boolean posicionarflota(String[][] matrix, int posicionHorizontal, int posicionVertical, String alineacion,
            String barco) {
        ...
        if (!matrix[posicionHorizontal][posicionVertical].equals("")) {
            ...
            /**
             * check that the initial position marked by the user part of the fleet is not
             * left out.
             */
            if (posicionHorizontal + espacio > 10) {
                answer = false;
                error = "el " + barco + " ocupa " + espacio + " espacios. Trata con al menos "
                        + (posicionHorizontal + espacio - 10) + " posiciones hacia la izquierda.";
            } else {
                for (int i = posicionHorizontal; i < posicionHorizontal + espacio; i++) {
                    ...
                    /**
                     * after having carried out all the revisions, it is verified that the boat can
                     * be added.
                     */
         ...
         */
            ...
            if (posicionVertical + espacio > 10) {
                answer = false;
                error = "el " + barco + " ocupa " + espacio + " espacios. Trata con al menos "
                        + (posicionVertical + espacio - 10) + " posiciones hacia arriba.";
            } else {
     ...
     */
    private void setTableroPosicion(String[][] matrix, int posicionHorizontal, int posicionVertical, String alineacion,
            String barco, int espacio) {
        int contador = 1;
    ...
    /**
     * @return the matrix with the information of where the user's fleet is
     *         positioned.
     */
    ...
    public void ingresarBarcosMaquina() {
        for (int i = 0; i < 10; i++) {
            ...
            while (!posicionarflota(tableroPosMaquina, machine.getCoordenadaX(), machine.getCoordenadaY(),
